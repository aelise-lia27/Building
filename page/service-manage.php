                        ...
                        <div class="modal-body">
                            <form id="serviceForm">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="serviceName" name="serviceName" placeholder="Ex: Location de bétonnière">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="servicePrice" name="servicePrice" placeholder="50">
                                </div>
                                
                                <div class="form-group">
                                    <label for="serviceDescription">Description</label>
                                    <textarea id="serviceDescription" name="serviceDescription" rows="4" placeholder="Décrivez le service en détail..."></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="image-upload">
                                        ...
                                        <input type="file" id="serviceImages" name="serviceImages" multiple style="display: none;">
                                        <div class="image-preview" id="imagePreview"></div>
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label for="serviceAvailability">Disponibilité</label>
