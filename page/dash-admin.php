            ...
            <!-- <div class="modal-body">
                <form id="serviceForm">
                    <div class="form-group">
                        ...
                        <input type="text" id="serviceName" placeholder="Ex: Location de bétonnière" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="servicePrice">Prix (cfa/jour)</label>
                        <input type="number" id="servicePrice" placeholder="50" required>
                    </div>
