...
<main>
    ...
    <section class="properties-section">
        ...
        <div class="properties-grid">
            <?php foreach ($expensiveHouses as $expensiveHouse) : ?>
            <!-- Property 1 -->
            <div class="property-card">
                <div class="property-image">
                    <img src="<?= htmlspecialchars($expensiveHouse['image']) ?>" alt="Villa d'exception">
                    <?php if (isset($expensiveHouse['badge'])): ?>
                    <div class="property-badge"><?= htmlspecialchars($expensiveHouse['badge']) ?></div>
                    <?php endif; ?> 
                </div>
                <div class="property-content">
                    <h3><?= htmlspecialchars($expensiveHouse['title']) ?></h3>
                    ...
                    <div class="property-price"><?= htmlspecialchars($expensiveHouse['price']) ?> fcfa</div>
