...
<main class="container">
    ...
    <section class="equipment-section">
        ...
        <div class="equipment-grid">
            <?php foreach ($construtionTools as $construtionTool) : ?>
                <!-- Outil  -->
                <div class="equipment-card">
                    ...
                    <div class="equipment-info">
                        <h3><i class="fas fa-bolt"></i><?= $construtionTool['title'] ?></h3>
                        <p class="description"><?= $construtionTool['description'] ?></p>
                        <div class="specs">
                            <span><i class="fas fa-battery-three-quarters"></i> 18V</span>
                            <span><i class="fas fa-tachometer-alt"></i> 3000 rpm</span>
                        </div>
                        <div class="price"><?= $construtionTool['price'] ?>FCFA <span class="period">/mois</span></div>
    ...
    <section class="equipment-section vehicles">
        ...
        <div class="equipment-grid">
            <?php foreach ($construtionCars as $construtionCar) : ?>
                <!-- Véhicule 1 -->
                <div class="equipment-card">
                    <div class="equipment-image">
                    ...
                    <div class="equipment-info">
                        <h3><i class="fas fa-crane"></i><?= $construtionCar['title'] ?></h3>
                        <p class="description"><?= $construtionCar['description'] ?></p>
                        <div class="specs">
                            <span><i class="fas fa-arrows-alt-v"></i> 28m</span>
                            <span><i class="fas fa-weight"></i> 6T</span>
                        </div>
                        <div class="price"><?= $construtionCar['price'] ?><span class="period">/mois</span></div>
                        <button class="rent-btn"><i class="fas fa-cart-plus"></i> Louer maintenant</button>
                    </div>
                <?php endforeach; ?>
                </div>
